  ...
  return (
    ...
    >
      ...
      >
        <div
          style={{ transform }}
          className="absolute left-1/2 top-1/2 flex items-start justify-start rounded-2xl border border-white/[0.12] bg-[#0b1530] p-4 shadow-[0_8px_16px_rgb(0_0_0/0.35)] transition duration-700 overflow-hidden group-hover/pin:border-white/[0.28]"
        >
...
export const PinPerspective = ({
  ...
  return (
    <motion.div className="pointer-events-none z-[60] flex h-80 w-96 items-center justify-center opacity-0 transition duration-500 group-hover/pin:opacity-100">
      <div className="inset-0 mt-[-1.75rem] h-full w-full flex-none">
        <div className="absolute inset-x-0 top-0 flex justify-center">
          <span className="relative z-10 inline-flex items-center rounded-full bg-zinc-950 px-4 py-0.5 ring-1 ring-white/10">
